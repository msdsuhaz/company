        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
              <form action="{{route('clients.update',$editdata->id)}}" method="POST"  enctype="multipart/form-data">
                    @csrf
                    ...
                    <input type="text" class="form-control" id="Heading" value="{{$editdata->Heading}}" name="Heading" required>
                      ...
                      <div class="form-group">
                        <img  id="showImage"  src="{{(!empty($editdata->image))?asset('/upload/clients_image/'.$editdata->image):asset('/upload/no_image.png')}}">
                        </div>
